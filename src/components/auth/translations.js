export const translations = {
  ko: {
    ...
    landingTitle: '체험하기',
    landingSubtitle: '가입 없이 역할을 골라 바로 둘러볼 수 있어요.',
    landingOwnerButton: '대표로 체험하기',
    landingMemberButton: '팀원으로 체험하기',
    landingLoggingIn: '접속하는 중…',
    landingLoginLink: '이미 계정이 있으신가요? 로그인',
    demoLoginFailed: '지금은 체험 계정을 사용할 수 없습니다. 잠시 후 다시 시도해 주세요.',
  },
  en: {
    ...
    landingTitle: 'Try it out',
    landingSubtitle: 'Pick a role and look around — no signup needed.',
    landingOwnerButton: 'Try as an Owner',
    landingMemberButton: 'Try as a Member',
    landingLoggingIn: 'Signing you in…',
    landingLoginLink: 'Already have an account? Log in',
    demoLoginFailed: 'The demo account is unavailable right now. Please try again shortly.',
  },
};
